...
/*****************************************************************************/
/*!	\file		dnp3servertest.cs
 *	\brief 		C# Source code file, DNP3 Outstation library test program
 *
...
namespace dnp3outstationtest
{
    class Program
    {
        ...
        ******************************************************************************/
        static short cbColdRestart( ushort u16ObjectId, ref dnp3types.sDNP3DataAttributeID psDAID, ref short ptErrorValue)
        {
        ...
        ******************************************************************************/
        static short cbWarmRestart( ushort u16ObjectId, ref dnp3types.sDNP3DataAttributeID psDAID, ref short ptErrorValue)
        {
        ...
        * Select callback
        ******************************************************************************/
        static short cbSelect(ushort u16ObjectId, ref dnp3types.sDNP3DataAttributeID psSelectID, ref dnp3types.sDNP3DataAttributeData psSelectValue, ref dnp3types.sDNP3CommandParameters psSelectParams, ref short ptErrorValue)
        {
            Console.WriteLine("\r\n cbSelect called");

            if (psSelectID.eGroupID == dnp3types.eDNP3GroupID.ANALOG_OUTPUTS)
            {
                Console.WriteLine("GROUP ID : ANALOG_OUTPUT");
                Console.WriteLine("Index Number " + psSelectID.u16IndexNumber);
                

                if (psSelectParams.eCommandVariation == dnp3types.eCommandObjectVariation.ANALOG_OUTPUT_BLOCK_FLOAT32)
                {
                ...
                else if (psSelectParams.eCommandVariation == dnp3types.eCommandObjectVariation.ANALOG_OUTPUT_BLOCK_INTEGER32)
                {
                ...
                else if (psSelectParams.eCommandVariation == dnp3types.eCommandObjectVariation.ANALOG_OUTPUT_BLOCK_INTEGER16)
                {
            ...
            if (psSelectID.eGroupID == dnp3types.eDNP3GroupID.BINARY_OUTPUT)
            {
                Console.WriteLine("GROUP ID : BINARY_OUTPUT");
                Console.WriteLine("Index Number " + psSelectID.u16IndexNumber);

                if (psSelectParams.eCommandVariation == dnp3types.eCommandObjectVariation.CROB_G12V1)
                {
        ...
        * Operate callback
        ******************************************************************************/
        static short cbOperate( ushort u16ObjectId, ref dnp3types.sDNP3DataAttributeID psOperateID, ref dnp3types.sDNP3DataAttributeData psOperateValue, ref dnp3types.sDNP3CommandParameters psOperateParams, ref short ptErrorValue)
        {
            Console.WriteLine("\r\n cbOperate called");

            if (psOperateID.eGroupID == dnp3types.eDNP3GroupID.ANALOG_OUTPUTS)
            {
                Console.WriteLine("GROUP ID : ANALOG_OUTPUT");
                Console.WriteLine("Index Number " + psOperateID.u16IndexNumber);


                if (psOperateParams.eCommandVariation == dnp3types.eCommandObjectVariation.ANALOG_OUTPUT_BLOCK_FLOAT32)
                {
                    Console.WriteLine("Variation : ANALOG_OUTPUT_BLOCK_FLOAT32");
                    SingleInt32Union f32Data;
                    f32Data.f = 0;
                ...
                else if (psOperateParams.eCommandVariation == dnp3types.eCommandObjectVariation.ANALOG_OUTPUT_BLOCK_INTEGER32)
                {
                    Console.WriteLine("Variation : ANALOG_OUTPUT_BLOCK_INTEGER32");
                    Console.WriteLine("Data : {0:D}", System.Runtime.InteropServices.Marshal.ReadInt32(psOperateValue.pvData));

                }
                else if (psOperateParams.eCommandVariation == dnp3types.eCommandObjectVariation.ANALOG_OUTPUT_BLOCK_INTEGER16)
                {
                    Console.WriteLine("Variation : ANALOG_OUTPUT_BLOCK_INTEGER16");
            ...
            if (psOperateID.eGroupID == dnp3types.eDNP3GroupID.BINARY_OUTPUT)
            {
                Console.WriteLine("GROUP ID : BINARY_OUTPUT");
                Console.WriteLine("Index Number " + psOperateID.u16IndexNumber);

                if (psOperateParams.eCommandVariation == dnp3types.eCommandObjectVariation.CROB_G12V1)
                {
                    Console.WriteLine("Variation : CROB_G12V1");
                }
                else
        ...
        * Debug callback
        ******************************************************************************/
        static short cbDebug( ushort u16ObjectId, ref dnp3types.sDNP3DebugData psDebugData, ref short ptErrorValue)
        {
            //Console.WriteLine("\r\n cbDebug called");
            ...
            if ((psDebugData.u32DebugOptions & (uint)tgtcommon.eDebugOptionsFlag.DEBUG_OPTION_RX) == (uint)tgtcommon.eDebugOptionsFlag.DEBUG_OPTION_RX)
            {


                if (psDebugData.eCommMode == dnp3types.eCommunicationMode.COMM_SERIAL)
                {
            ...
            if ((psDebugData.u32DebugOptions & (uint)tgtcommon.eDebugOptionsFlag.DEBUG_OPTION_TX) == (uint)tgtcommon.eDebugOptionsFlag.DEBUG_OPTION_TX)
            {
            ...
            if ((psDebugData.u32DebugOptions & (uint)tgtcommon.eDebugOptionsFlag.DEBUG_OPTION_ERROR) == (uint)tgtcommon.eDebugOptionsFlag.DEBUG_OPTION_ERROR)
            {
            ...
            if ((psDebugData.u32DebugOptions & (uint)tgtcommon.eDebugOptionsFlag.DEBUG_OPTION_WARNING) == (uint)tgtcommon.eDebugOptionsFlag.DEBUG_OPTION_WARNING)
            {
        ...
        * Write callback
        ******************************************************************************/
        static short cbWrite( ushort u16ObjectId,  dnp3types.eWriteFunctionID eFunctionID, ref dnp3types.sDNP3DataAttributeID ptWriteID, ref dnp3types.sDNP3DataAttributeData ptWriteValue, ref dnp3types.sDNP3WriteParameters ptWriteParams, ref short ptErrorValue)
        {
            Console.WriteLine("\r\n cbWrite called");
    ...
    ******************************************************************************/
        ...
        {
            dnp3types.sDNP3ErrorCode sDNP3ErrorCodeDes;
            sDNP3ErrorCodeDes = new dnp3types.sDNP3ErrorCode();

            sDNP3ErrorCodeDes.iErrorCode = errorcode;
            
            dnp3api.DNP3ErrorCodeString(ref sDNP3ErrorCodeDes);
        ...
        ******************************************************************************/
        ...
        {
            dnp3types.sDNP3ErrorValue sDNP3ErrorValueDes;
            sDNP3ErrorValueDes = new dnp3types.sDNP3ErrorValue();

            sDNP3ErrorValueDes.iErrorValue = errorvalue;

            dnp3api.DNP3ErrorValueString(ref sDNP3ErrorValueDes);
        ...
        ******************************************************************************/        
        static void Main(string[] args)
        {
            ...
            dnp3types.sDNP3Parameters sParameters;    // DNP3 Server object callback paramters 

            System.Console.WriteLine("\r\n \t\t**** DNP3 Protocol Outstation Library Test ****");

            try
            {
                if (String.Compare(System.Runtime.InteropServices.Marshal.PtrToStringAnsi(dnp3api.DNP3GetLibraryVersion()), dnp3api.DNP3_VERSION, true) != 0)
                {
                    System.Console.WriteLine("\r\nError: Version Number Mismatch");
                    System.Console.WriteLine("Library Version is : {0:D}", System.Runtime.InteropServices.Marshal.PtrToStringAnsi(dnp3api.DNP3GetLibraryVersion()));
                    System.Console.WriteLine("The Version used is : {0:D}", dnp3api.DNP3_VERSION);
            ...
            System.Console.WriteLine("Library Version is : {0:D}", System.Runtime.InteropServices.Marshal.PtrToStringAnsi(dnp3api.DNP3GetLibraryVersion()));
            System.Console.WriteLine("Library Build on   : {0:D}", System.Runtime.InteropServices.Marshal.PtrToStringAnsi(dnp3api.DNP3GetLibraryBuildTime()));
            System.Console.WriteLine("Library Licence Information  : {0:D}", System.Runtime.InteropServices.Marshal.PtrToStringAnsi(dnp3api.DNP3GetLibraryLicenseInfo()));


            DNP3serverhandle = System.IntPtr.Zero;
            sParameters = new dnp3types.sDNP3Parameters();
            
            // Initialize parameters
            sParameters.eAppFlag = tgtcommon.eApplicationFlag.APP_SERVER;			            // This is a DNP3 Server   
            sParameters.ptReadCallback = null;					                            // Read Callback
            sParameters.ptWriteCallback = new dnp3types.DNP3WriteCallback(cbWrite);				// Write Callback           
            sParameters.ptUpdateCallback = null;					                        // Update Callback
            sParameters.ptSelectCallback = new dnp3types.DNP3ControlSelectCallback(cbSelect);	// Select commands
            sParameters.ptOperateCallback =  new dnp3types.DNP3ControlOperateCallback(cbOperate);// Operate commands
            sParameters.ptDebugCallback =  new dnp3types.DNP3DebugMessageCallback(cbDebug);		// Debug Callback
            sParameters.ptColdRestartCallback = new dnp3types.DNP3ColdRestartCallback(cbColdRestart);    // ColdRestart Callback
            sParameters.ptWarmRestartCallback =  new dnp3types.DNP3WarmRestartCallback(cbWarmRestart);   // ColdRestart Callback
             ...
             do
            {
                ...
                DNP3serverhandle = dnp3api.DNP3Create(ref sParameters, ref iErrorCode, ref ptErrorValue);
                ...
                dnp3types.sDNP3ConfigurationParameters sDNP3Config;
                sDNP3Config = new dnp3types.sDNP3ConfigurationParameters();

#if SERVER_TCP_COMMUNICATION

   // tcp communication settings
   sDNP3Config.sDNP3ServerSet.sServerCommunicationSet.eCommMode                     =   dnp3types.eCommunicationMode.TCP_IP_MODE;
   ...
   //protocol communication settings
    ...
    sDNP3Config.sDNP3ServerSet.sServerProtSet.sStaticVariation.eDeStVarBI                               =   dnp3types.eDefaultStaticVariationBinaryInput.BI_WITH_FLAGS;                      // Default Static variation Binary Input
    sDNP3Config.sDNP3ServerSet.sServerProtSet.sStaticVariation.eDeStVarDBI                              =   dnp3types.eDefaultStaticVariationDoubleBitBinaryInput.DBBI_WITH_FLAGS;                // Default Static variation Double Bit Binary Input
    sDNP3Config.sDNP3ServerSet.sServerProtSet.sStaticVariation.eDeStVarBO                               =   dnp3types.eDefaultStaticVariationBinaryOutput.BO_WITH_FLAGS;                      // Default Static variation Double Bit Binary Output
    sDNP3Config.sDNP3ServerSet.sServerProtSet.sStaticVariation.eDeStVarCI                               =   dnp3types.eDefaultStaticVariationCounterInput.CI_32BIT_WITHFLAG;                      // Default Static variation counter Input
    sDNP3Config.sDNP3ServerSet.sServerProtSet.sStaticVariation.eDeStVarFzCI                             =   dnp3types.eDefaultStaticVariationFrozenCounterInput.FCI_32BIT_WITHFLAGANDTIME;          // Default Static variation Frozen counter Input
    sDNP3Config.sDNP3ServerSet.sServerProtSet.sStaticVariation.eDeStVarAI                               =   dnp3types.eDefaultStaticVariationAnalogInput.AI_SINGLEPREC_FLOATWITHFLAG;                        // Default Static variation Analog Input
    sDNP3Config.sDNP3ServerSet.sServerProtSet.sStaticVariation.eDeStVarFzAI                             =   dnp3types.eDefaultStaticVariationFrozenAnalogInput.FAI_SINGLEPRECFLOATWITHFLAG;        // Default Static variation frozen Analog Input
    sDNP3Config.sDNP3ServerSet.sServerProtSet.sStaticVariation.eDeStVarAID                              =   dnp3types.eDefaultStaticVariationAnalogInputDeadBand.DAI_SINGLEPRECFLOAT;            // Default Static variation Analog Input Deadband
    sDNP3Config.sDNP3ServerSet.sServerProtSet.sStaticVariation.eDeStVarAO                               =   dnp3types.eDefaultStaticVariationAnalogOutput.AO_SINGLEPRECFLOAT_WITHFLAG;    // Default Static variation Analog Output

    sDNP3Config.sDNP3ServerSet.sServerProtSet.sEventVariation.eDeEvVarBI                                =   dnp3types.eDefaultEventVariationBinaryInput.BIE_WITHOUT_TIME;               // Default event variation for binary input
    sDNP3Config.sDNP3ServerSet.sServerProtSet.sEventVariation.eDeEvVarDBI                               =   dnp3types.eDefaultEventVariationDoubleBitBinaryInput.DBBIE_WITH_ABSOLUTETIME;    // Default event variation for double bit binary input
    sDNP3Config.sDNP3ServerSet.sServerProtSet.sEventVariation.eDeEvVarCI                                =   dnp3types.eDefaultEventVariationCounterInput.CIE_32BIT_WITHFLAG_WITHTIME;            // Default event variation for Counter input
    sDNP3Config.sDNP3ServerSet.sServerProtSet.sEventVariation.eDeEvVarAI                                =   dnp3types.eDefaultEventVariationAnalogInput.AIE_SINGLEPREC_WITHTIME;                // Default event variation for Analog input
    sDNP3Config.sDNP3ServerSet.sServerProtSet.sEventVariation.eDeEvVarFzCI                              =   dnp3types.eDefaultEventVariationFrozenCounterInput.FCIE_32BIT_WITHFLAG_WITHTIME;       // Default event variation for Frozen counter input
    sDNP3Config.sDNP3ServerSet.sServerProtSet.sEventVariation.eDeEvVarFzAI                              =   dnp3types.eDefaultEventVariationFrozenAnalogInput.FAIE_SINGLEPREC_WITHTIME;           // Default event variation for Frozen Analog input
    sDNP3Config.sDNP3ServerSet.sServerProtSet.sEventVariation.eDeEvVarBO = dnp3types.eDefaultEventVariationBinaryOutput.BOE_WITH_TIME;               // Default event variation for binary Output
    sDNP3Config.sDNP3ServerSet.sServerProtSet.sEventVariation.eDeEvVarAO = dnp3types.eDefaultEventVariationAnalogOutput.AOE_SINGLEPREC_WITHTIME;                // Default event variation for Analog Output
    ...
    sDNP3Config.sDNP3ServerSet.sServerProtSet.eAIDeadbandMethod     =   dnp3types.eAnalogInputDeadbandMethod.DEADBAND_FIXED;                                  /*!< Analog Input Deadband Calculation method*/
    ...
    sDNP3Config.sDNP3ServerSet.sServerProtSet.u8IntialdatabaseQualityFlag = (byte)dnp3types.eDNP3QualityFlags.ONLINE;       /*!< 0- OFFLINE, 1 BIT- ONLINE, 2 BIT-RESTART, 3 BIT -COMMLOST, MAX VALUE -7   */
...
#if VIEW_TRAFFIC
   sDNP3Config.sDNP3ServerSet.sDebug.u32DebugOptions = (uint)(tgtcommon.eDebugOptionsFlag.DEBUG_OPTION_TX | tgtcommon.eDebugOptionsFlag.DEBUG_OPTION_RX);
#else
    ...
    // Allocate memory for objects
                ...
                // Allocate memory for objects
                dnp3types.sDNP3Object[] psDNP3Objects = new dnp3types.sDNP3Object[sDNP3Config.sDNP3ServerSet.u16NoofObject];
                ...
                for (int i = 0; i < sDNP3Config.sDNP3ServerSet.u16NoofObject; ++i)
                {
                    switch (i)
                    {
                        ...
                        case 0:
                            ...
                            psDNP3Objects[0].eGroupID       =   dnp3types.eDNP3GroupID.BINARY_INPUT;
                            psDNP3Objects[0].u16NoofPoints  =   10;
                            psDNP3Objects[0].eClassID       =   dnp3types.eDNP3ClassID.CLASS_THREE;
                            psDNP3Objects[0].eControlModel  =   dnp3types.eDNP3ControlModelConfig.INPUT_STATUS_ONLY;
                            psDNP3Objects[0].u32SBOTimeOut  =   0;
                            psDNP3Objects[0].f32AnalogInputDeadband  =   0;
                            psDNP3Objects[0].eAnalogStoreType = dnp3types.eAnalogStorageType.AS_FLOAT;
                            break;

                        case 1:
                            psDNP3Objects[1].ai8Name ="binary output 0-9";
                            psDNP3Objects[1].eGroupID = dnp3types.eDNP3GroupID.BINARY_OUTPUT;
                            psDNP3Objects[1].u16NoofPoints  =   10;
                            psDNP3Objects[1].eClassID = dnp3types.eDNP3ClassID.NO_CLASS;
                            psDNP3Objects[1].eControlModel = dnp3types.eDNP3ControlModelConfig.DIRECT_OPERATION;
                            psDNP3Objects[1].u32SBOTimeOut  =   0;
                            psDNP3Objects[1].f32AnalogInputDeadband  =  0;
                            psDNP3Objects[1].eAnalogStoreType = dnp3types.eAnalogStorageType.AS_FLOAT;
                            break;

                        case 2:
                            psDNP3Objects[2].ai8Name = "analog input 0-9";
                            psDNP3Objects[2].eGroupID = dnp3types.eDNP3GroupID.ANALOG_INPUT;
                            psDNP3Objects[2].u16NoofPoints = 10;
                            psDNP3Objects[2].eClassID = dnp3types.eDNP3ClassID.CLASS_ONE;
                            psDNP3Objects[2].eControlModel = dnp3types.eDNP3ControlModelConfig.INPUT_STATUS_ONLY;
                            psDNP3Objects[2].u32SBOTimeOut = 0;
                            psDNP3Objects[2].f32AnalogInputDeadband = 0;
                            psDNP3Objects[2].eAnalogStoreType = dnp3types.eAnalogStorageType.AS_FLOAT;
                            break;

                        case 3:
                            psDNP3Objects[3].ai8Name = "analog output 0-9";
                            psDNP3Objects[3].eGroupID = dnp3types.eDNP3GroupID.ANALOG_OUTPUTS;
                            psDNP3Objects[3].u16NoofPoints  =   10;
                            psDNP3Objects[3].eClassID = dnp3types.eDNP3ClassID.NO_CLASS;
                            psDNP3Objects[3].eControlModel = dnp3types.eDNP3ControlModelConfig.DIRECT_OPERATION;
                            psDNP3Objects[3].u32SBOTimeOut  =   0;
                            psDNP3Objects[3].f32AnalogInputDeadband  =  0;
                            psDNP3Objects[3].eAnalogStoreType = dnp3types.eAnalogStorageType.AS_FLOAT;
                            break;
                    }
                ...
                // Load configuration
                iErrorCode = dnp3api.DNP3LoadConfiguration(DNP3serverhandle, ref sDNP3Config, ref ptErrorValue);
                if(iErrorCode != 0)
                {
                ...
                // Start server
                iErrorCode = dnp3api.DNP3Start(DNP3serverhandle, ref ptErrorValue);
                if (iErrorCode != 0)
                {
                ...
                ushort uiCount = 1;
                dnp3types.sDNP3DataAttributeID[] psDAID = new dnp3types.sDNP3DataAttributeID[uiCount];
                dnp3types.sDNP3DataAttributeData[] psNewValue = new dnp3types.sDNP3DataAttributeData[uiCount];
                                             


                psDAID[0].u16SlaveAddress = 1;
                psDAID[0].eGroupID = dnp3types.eDNP3GroupID.ANALOG_INPUT;
                ...
                psNewValue[0].tQuality = (ushort)(dnp3types.eDNP3QualityFlags.ONLINE);
                ...
                while (true)
                {
                    ...
                    else
                    {
                        ...
                        // Update server
                        iErrorCode = dnp3api.DNP3Update(DNP3serverhandle, ref psDAID[0], ref psNewValue[0], uiCount, dnp3types.eUpdateClassID.UPDATE_DEFAULT_EVENT, ref ptErrorValue);
                        if (iErrorCode != 0)
                        {
                ...
                // Stop server
                iErrorCode = dnp3api.DNP3Stop(DNP3serverhandle, ref ptErrorValue);
                if (iErrorCode != 0)
                {
                ...
                // Free server
                iErrorCode = dnp3api.DNP3Free(DNP3serverhandle, ref ptErrorValue);
                if (iErrorCode != 0)
                {
